#!/usr/bin/env python3
"""Check Batch 9L reports for claim-boundary violations."""
...
REPORT_JSON = REPORTS_DIR / "batch_9l_claim_boundary_check.json"
REPORT_MD = REPORTS_DIR / "batch_9l_claim_boundary_check.md"

REPORTS = [
    "batch_9l_first_failure_target_summary.md",
    "batch_9l_first_failure_model_results.md",
    "batch_9l_first_failure_intervention.md",
    "batch_9l_first_failure_calibration.md",
    "batch_9l_first_failure_shift_groups.md",
...
def main() -> None:
    ...
    REPORT_MD.write_text("\n".join([
        ...
        "",
        "Required safe concepts include benchmark-level, CodeTraceBench-derived, offline proxy, first-failure, trajectory-level burden, row-level risk, calibration support, domain shift, not production validation, not causal prevention, and no formal conformal guarantee claimed.",
    ]) + "\n")
